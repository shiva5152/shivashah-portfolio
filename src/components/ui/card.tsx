...
export function CardDemo() {
  return (
    <div id="skills" className="pt-20 max-md:pt-10">
      <Card className="mx-4">
        <CardTitle className="text-center text-black dark:text-white  text-lg md:text-4xl mb-4  ">
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        " max-md:w-fit w-full mx-auto p-8 max-md:px-4  rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
